...
function InOutQuad( x )
	return x < 0.5 && 2 * x ^ 2 or 1 - ( ( -2 * x + 2 ) ^ 2 ) / 2
end
...
function InOutCubic( x )
	return x < 0.5 && 4 * x ^ 3 or 1 - ( ( -2 * x + 2 ) ^ 3 ) / 2
end
...
function InOutQuart( x )
	return x < 0.5 && 8 * x ^ 4 or 1 - ( ( -2 * x + 2 ) ^ 4 ) / 2
end
...
function InOutQuint( x )
	return x < 0.5 && 16 * x ^ 5 or 1 - ( ( -2 * x + 2 ) ^ 5 ) / 2
end

function InExpo( x )
	return x == 0 && 0 or ( 2 ^ ( 10 * x - 10 ) )
end

function OutExpo( x )
	return x == 1 && 1 or 1 - ( 2 ^ ( -10 * x ) )
end
