...
function meta:SnapTo( component, degrees )
	...
	if ( !self[ component ] ) then ErrorNoHalt( "You must choose a valid component of Angle( p or pitch, y or yaw, r or roll ) to snap such as Angle( 80, 40, 30 ):SnapTo( \"p\", 90 ):SnapTo( \"y\", 45 ):SnapTo( \"r\", 40 ) and yes, you can keep adding snaps.\n" ) return self end
